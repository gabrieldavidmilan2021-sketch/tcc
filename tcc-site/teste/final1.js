document.addEventListener("DOMContentLoaded", () => {
  ...
  const frases = [
    "Zero: O painel perdeu a estrutura da página. Você pode me ajudar a reconstruí-la?",
    "As tags HTML organizam o conteúdo. Primeiro abrimos html; dentro dele vêm head e body.",
    "Caminhe pelo mapa com W, A, S e D. Encontre a tag que o painel pede e aperte F para coletá-la. Se escolher outra, Zero explica e você pode tentar de novo."
  ];
  ...
  $("#proximaFase").addEventListener("click", () => { window.location.href = "../fase3.html"; });
});
